...
- `migrations/20260406_002_verification_templates_and_duplicates.sql`
  Adds category template rules, duplicate-match storage fields, and verification indexes.
...
2. Run `migrations/20260406_002_verification_templates_and_duplicates.sql`
3. Run `sql/assign_user_metadata.sql`
